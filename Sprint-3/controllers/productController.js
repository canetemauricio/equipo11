...
let products = require('../data/heroes.json')

module.exports = {

    list: function(req,res){
        res.render('./products/heroes', {title: "PRODUCTS - MAG", products})
    }, //   FUNCIONA
    show: function (req,res){
        ...
        if (productResult){
            return res.render('./products/detail', { title: productResult.alias, productResult})
        }
    },  //  FUNCIONA 
    search: function(req,res){
        ...
        res.render('./products/productSearch', {title: "SEARCH RESULTS - MAG", results,})
    ...
    save: function(req,res){
        ...
        productsFile = fs.readFileSync('./data/heroes.json', {encoding: 'utf-8'})
        ...
        fs.writeFileSync('./data/heroes.json', productsJSON)
