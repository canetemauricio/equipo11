...
module.exports = {
                ...
                return profile.findOne({
                    ...
                    if (profile) {
                        if(!bcrypt.compareSync(req.body.password, profile.password)) {
                            ...
                            return Promise.reject('1 - Email o Contraseña invalidos')
                        }
                    } else {
                        return Promise.reject('2 - Email o Contraseña Invalidos')
                    }
                });
            }),
    ],
    createProduct: [
        ...
        body('brand')
            ...
            .bail()
            .isLength({ max : 20})
            .withMessage('El nombre debe tener un maximo de 20 caracteres')
            .bail(),
        body('gender')
            .notEmpty()
            .withMessage('Campo Obligatorio')
            ...
            .bail()
            .isLength({ max : 10})
            .withMessage('El nombre debe tener un maximo de 10 caracteres')
            .bail(),
        body('image')
            .notEmpty()
            .withMessage('Campo Obligatorio')
